...
#
#	$Id: advertisement.tpl.php 25 2014-01-10 03:13:43Z along $
#
...
<tr>
	...
	<td><select name="adv_position" onchange="chg_img(this.options[this.selectedIndex].value);">
...
<tr>
	<td><b><?=__('position_view')?>:</b><br /><span class="txtgray"><?=__('position_view_tips')?></span></td>
	<td><img id="adv_img" src="" align="absmiddle" border="0"/></td>
</tr>
<tr>
...
<tr>
	<td><b><?=__('adv_starttime')?>(<?=__('optional')?>):</b><br /><span class="txtgray"><?=__('adv_starttime_tips')?>
...
<tr>
	<td colspan="2" class="bold"><?=__('content_error')?>:</td>
</tr>
<tr>
...
function chg_img(val){
	getId('adv_img').src = "{$admin_tpl_dir}images/adv_snapshot/"+val+".jpg";
}
function dosubmit(o){
