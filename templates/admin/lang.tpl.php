...
#
#	$Id: lang.tpl.php 25 2014-01-10 03:13:43Z along $
#
...
<tr>
	<td width="50%"><span class="bold"><?=__('open_switch_langs')?></span>: <br /><span class="txtgray"><?=__('open_switch_langs_tips')?></span></td>
...
<tr class="{$color}">
	...
	<!--# }else{#-->
	<a href="{#urr(ADMINCP,"item=lang&menu=lang_tpl&lang_name=".$v['lang_dir']."&action=active")#}" class="txtblue"><?=__('default_lang')?></a>
	<!--#}#-->
	</td>
</tr>
<!--#
