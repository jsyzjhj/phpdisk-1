...
#
#	$Id: mysql.class.php 25 2014-01-10 03:13:43Z along $
#
...
class cls_mysql{
	...
	function error ($s){
		...
		$rtn .= '<p><a href="http://faq.phpdisk.com/search?w='.$msg.'" target="_blank">[<span style="color:#FF0000;">PHPDisk DB Connect error!</span>]&nbsp;'.$msg.'</a><br><br>';
		$rtn .= '</p></div>';
		return $rtn;
	}
	// add for phpwind
