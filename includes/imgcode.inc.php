...
#
#	$Id: imgcode.inc.php 33 2014-05-29 07:38:42Z along $
#
...
error_reporting(0);
session_start();
$verycode_type = isset($_GET['verycode_type']) ? (int)$_GET['verycode_type'] : 0;
$nosess = isset($_GET['nosess']) ? (int)$_GET['nosess'] : 0;
